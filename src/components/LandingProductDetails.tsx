...
export default function LandingProductDetails({ onBackToHome, onSelectPlan }: LandingProductDetailsProps) {
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-20">
          ...
          <div className="lg:col-span-5 relative">
            <div className="bg-gradient-to-b from-blue-950/40 to-neutral-900/60 border border-blue-500/20 rounded-3xl p-8 relative overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
              ...
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between items-end mb-1.5">
                    <span className="text-xs text-neutral-400 font-bold uppercase tracking-wider">Taxa de Conversão</span>
                ...
                <div>
                  <div className="flex justify-between items-end mb-1.5">
                    <span className="text-xs text-neutral-400 font-bold uppercase tracking-wider">Velocidade Mobile (PageSpeed)</span>
                ...
                <div>
                  <div className="flex justify-between items-end mb-1.5">
                    <span className="text-xs text-neutral-400 font-bold uppercase tracking-wider">Retenção de Tráfego Direto</span>
        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            {/* Marketplace Comum */}
            <div className="bg-neutral-900/40 border border-white/5 rounded-3xl p-8 relative flex flex-col justify-between">
              <div>
                <span className="block text-xxs font-black text-neutral-500 tracking-wider uppercase mb-2">Anúncio Comum de Marketplace</span>
                <div className="text-5xl font-black text-neutral-400 mb-4 select-none">2-4% CONV</div>
                <h4 className="text-neutral-200 font-bold text-sm mb-2">Fricção e Dispersão Elevada</h4>
              ...
              <div className="mt-6 pt-4 border-t border-white/5 text-neutral-500 text-xxs font-medium uppercase tracking-widest select-none">
        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 select-none">
            ...
            <div className="bg-neutral-900/20 border border-white/5 rounded-2xl p-6 relative hover:border-blue-500/20 transition-all">
              <div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-400 font-bold text-lg mb-4">
                🎯
              </div>
              <span className="text-[10px] font-black text-neutral-500 uppercase tracking-widest block mb-1">Fase 01</span>
              <h4 className="font-extrabold text-sm uppercase tracking-wider text-white mb-2">Briefing & Ângulo</h4>
            ...
            <div className="bg-neutral-900/20 border border-white/5 rounded-2xl p-6 relative hover:border-blue-500/20 transition-all">
              ...
              <span className="text-[10px] font-black text-neutral-500 uppercase tracking-widest block mb-1">Fase 02</span>
              <h4 className="font-extrabold text-sm uppercase tracking-wider text-white mb-2">Escrita Persuasiva</h4>
              <p className="text-neutral-400 text-xxs leading-relaxed">
            ...
            <div className="bg-neutral-900/20 border border-white/5 rounded-2xl p-6 relative hover:border-blue-500/20 transition-all">
              ...
              <span className="text-[10px] font-black text-neutral-500 uppercase tracking-widest block mb-1">Fase 03</span>
              <h4 className="font-extrabold text-sm uppercase tracking-wider text-white mb-2">Design & Checkout</h4>
              <p className="text-neutral-400 text-xxs leading-relaxed">
            ...
            <div className="bg-neutral-900/20 border border-white/5 rounded-2xl p-6 relative hover:border-blue-500/20 transition-all">
              ...
              <span className="text-[10px] font-black text-neutral-500 uppercase tracking-widest block mb-1">Fase 04</span>
              <h4 className="font-extrabold text-sm uppercase tracking-wider text-white mb-2">Código & Pixels</h4>
              <p className="text-neutral-400 text-xxs leading-relaxed">
        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-neutral-900/30 border border-white/5 rounded-2xl p-6 transition-all duration-300">
              <div className="w-10 h-10 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-400 mb-4 select-none">
                <Flame className="w-5 h-5" />
              </div>
              <h3 className="font-extrabold text-sm uppercase tracking-wider mb-2 text-white">Copy Estratégica de Conversão</h3>
              <p className="text-neutral-400 text-xs leading-relaxed">
            ...
            <div className="bg-neutral-900/30 border border-white/5 rounded-2xl p-6 transition-all duration-300">
              ...
              <h3 className="font-extrabold text-sm uppercase tracking-wider mb-2 text-white">Design Mobile-First Absoluto</h3>
              <p className="text-neutral-400 text-xs leading-relaxed">
            ...
            <div className="bg-neutral-900/30 border border-white/5 rounded-2xl p-6 transition-all duration-300">
              ...
              <h3 className="font-extrabold text-sm uppercase tracking-wider mb-2 text-white">Checkout Otimizado de Um Clique</h3>
              <p className="text-neutral-400 text-xs leading-relaxed">
            ...
            <div className="bg-neutral-900/30 border border-white/5 rounded-2xl p-6 transition-all duration-300">
              ...
              <h3 className="font-extrabold text-sm uppercase tracking-wider mb-2 text-white">Tracking & Pixel Integrado</h3>
              <p className="text-neutral-400 text-xs leading-relaxed">
            ...
            <div className="bg-neutral-900/30 border border-white/5 rounded-2xl p-6 transition-all duration-300">
              ...
              <h3 className="font-extrabold text-sm uppercase tracking-wider mb-2 text-white">Carregamento Ultra Veloz</h3>
              <p className="text-neutral-400 text-xs leading-relaxed">
            ...
            <div className="bg-neutral-900/30 border border-white/5 rounded-2xl p-6 transition-all duration-300">
              ...
              <h3 className="font-extrabold text-sm uppercase tracking-wider mb-2 text-white">Engenharia de Ofertas Integrada</h3>
              <p className="text-neutral-400 text-xs leading-relaxed">
              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <h4 className="font-display font-black text-lg text-white mb-4">{plan.name}</h4>
                    
                    <div className="flex items-baseline gap-1.5 mb-2">
                      <span className="text-3xl font-black text-white">{plan.price}</span>
                    </div>
                    <span className="block text-xxs font-bold text-neutral-400 uppercase tracking-wider mb-8">{plan.period}</span>

                    <ul className="flex flex-col gap-3.5 mb-8">
                      {plan.benefits.map((benefit, i) => (
                        <li key={i} className="flex items-start gap-2.5 text-xs text-neutral-300 text-left">
        ...
        {/* BOTTOM ACTION CARD */}
        <div className="bg-gradient-to-r from-blue-900/20 via-blue-950/40 to-indigo-950/20 border border-blue-500/20 rounded-3xl p-8 sm:p-12 text-center relative overflow-hidden flex flex-col items-center">
